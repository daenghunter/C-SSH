...
case `#nyimak`:
        ...
        case '#odelete':
            ...
            break
 case `#addlimit`:
			if (!isOwner) return xbot.reply(from, 'Maaf kak, hanya untuk Owner Bot.', id)
			var found = false;
                    Object.keys(limit).forEach((i) => {
...
case `#edotensei`:
        ...
        case `#esticker`: //XBOT
            ...
            if (isLimit(serial)) return xbot.reply(self, `Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik !limit Untuk Mengecek Kuota Limit Kamu`, id)
